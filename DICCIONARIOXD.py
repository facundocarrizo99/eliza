dic = {
    ...
    'relaciones': ("Las relaciones personales pueden ser complicadas. ¿Tienes dificultades en tus relaciones con familiares, amigos o parejas?", "Las relaciones son fundamentales. ¿Necesitas consejos sobre cómo mejorar tus relaciones?", "Hablemos sobre tus desafíos en las relaciones y cómo superarlos."),
    ...
    'adicciones': ("Las adicciones pueden tener un gran impacto en la vida. ¿Tienes problemas con el abuso de sustancias o comportamientos adictivos?", "Las adicciones son desafiantes. ¿Necesitas recursos para la recuperación?", "La recuperación de las adicciones es un proceso. ¿En qué etapa te encuentras?"),
    ...
    'trastornos alimentarios': ("Los trastornos alimentarios pueden afectar gravemente la salud. ¿Estás lidiando con problemas alimentarios? ¿Necesitas apoyo para superarlos?", "Hablemos de tus patrones alimentarios y cómo puedes trabajar en una relación más saludable con la comida.", "Los trastornos alimentarios son tratables. Estoy aquí para ayudarte en tu proceso de recuperación."),
    ...
    'padre': "Los padres suelen ser una parte importante de nuestra vida. ¿Tienes alguna preocupación o pregunta sobre tu padre?",
    'padres': "Los padres suelen ser una parte importante de nuestra vida. ¿Tienes alguna preocupación o pregunta sobre tus padres?",
    ...
    'abuelo': "Los abuelos tienen un lugar especial en nuestras vidas. ¿Tienes anécdotas o inquietudes sobre tu abuelo?",
    'abuelos': "Los abuelos tienen un lugar especial en nuestras vidas. ¿Tienes anécdotas o inquietudes sobre tus abuelos?",
    'hijo': "Los hijos son una gran responsabilidad. ¿Necesitas consejos sobre la crianza o tienes preocupaciones sobre tu hijo?",
    'hijos': "Los hijos son una gran responsabilidad. ¿Necesitas consejos sobre la crianza o tienes preocupaciones sobre tus hijos?",
    'pareja': "La pareja es una parte importante de la vida. ¿Tienes preguntas o inquietudes sobre tu pareja?",
    ...
    'tío': "Los tíos son miembros interesantes de la familia. ¿Tienes alguna anécdota o cuestiones que quieras compartir sobre tu tío?",
    'tíos': "Los tíos son miembros interesantes de la familia. ¿Tienes alguna anécdota o cuestiones que quieras compartir sobre tus tíos?",
    'sobrino': "Los sobrinos pueden ser una fuente de alegría. ¿Tienes historias o preocupaciones sobre tu sobrino?",
    'sobrinos': "Los sobrinos pueden ser una fuente de alegría. ¿Tienes historias o preocupaciones sobre tus sobrinos?",
